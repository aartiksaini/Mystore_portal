    ...
    return (
        <Provider store={Store}>
            ...
            <Routes>
                ...
                <Route path="/categorybeauty" element={<Item cat='beauty'/>} />
                <Route path="/categoryfragrances" element={<Item cat='fragrances' />} />
                <Route path="/categoryfurniture" element={<Item cat='furniture' />} />
                <Route path="/categorygroceries" element={<Item cat='groceries' />} />
            </Routes>
           </Router>
        </Provider>
    );
